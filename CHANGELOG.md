...
**测试**
- 前端 396 项、Rust 153 项；新增多项目并行运行登记、消息节点复用、消息与代码复制、深色令牌、拖入与选中图片校验、对话内搜索、`@` 项目文件的有界安全扫描、写入轮改动清单、待办转处理步骤、失败重试、历史筛选与改名，以及首次使用引导。
